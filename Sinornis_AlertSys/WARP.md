...
Based on Adobe XD prototype "Integrator dashboard V02" with 6 main screens:

1. **Main Dashboard** (`Integrator dashboard V2`)
   - Overview of all farms and system status
   - High-level metrics and alerts summary
   - Navigation to farm-specific views

2. **Farm Management** (`Integrator dashboard > farm V2`) 
   - Farm-level monitoring and controls
   - Multiple coop overview within a farm
   - Farm-specific alert management

3. **Alert Management** (`Alert details`)
   - Detailed alert information and history
   - Alert acknowledgment and resolution workflows
   - Alert filtering and categorization

4. **Individual Coop View** (`Integrator dashboard > farm > coop V2`)
   - Real-time sensor data visualization
   - Coop-specific environmental controls
   - Historical trend analysis

5. **Secondary Dashboard Views** (`salus – dashboard V02 – 1 & 2`)
   - Alternative dashboard layouts
   - Specialized monitoring views
   - Mobile-responsive design considerations

### Design Requirements
- **Screen Resolution:** 1920px width (desktop-first)
- **Framework:** Web-based responsive design
- **Navigation:** Hierarchical (Dashboard > Farm > Coop)
- **Real-time Updates:** Live sensor data display
- **Alert System:** Visual alert indicators and management

### Implementation Notes for Dashboard
- Use Flask/FastAPI for web server (currently stubbed in `src/dashboard/web_server.py`)
- Implement WebSocket connections for real-time data
- Create responsive grid layouts for sensor data
- Design alert notification system with visual indicators
- Support multi-level navigation (farm > coop hierarchy)
...
- Test web dashboard endpoints and real-time updates
