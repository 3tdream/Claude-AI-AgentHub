...
export const AGENT_CONFIG: Record<string, {
  ...
  "backend-agent":    { qualityThreshold: 7.5, escalationThreshold: 5, maxTurns: 3,  maxContextChars: 6000,  readBudget: 1,  diffSoft: { edit: 50, create: 120 }, diffHard: 250 },
  "frontend-agent":   { qualityThreshold: 7.5, escalationThreshold: 5, maxTurns: 3,  maxContextChars: 6000,  readBudget: 1,  diffSoft: { edit: 30, create: 80 }, diffHard: 150 },
